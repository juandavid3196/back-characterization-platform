...
router.get('/', (req, res) => {
    db.query('SELECT * FROM states', (error, results, fields) => {
        if (error) {
...
router.get('/:id', (req, res) => {
    ...
    db.query('SELECT * FROM states WHERE id = ?', [itemId], (error, results, fields) => {
        if (error) {
            console.error('Error al ejecutar la consulta:', error);
...
router.post('/', (req, res) => {
    ...
    db.query('INSERT INTO states SET ?', newItem, (error, results, fields) => {
        if (error) {
...
router.put('/:id', (req, res) => {
    ...
    db.query('UPDATE states SET ? WHERE id = ?', [updatedItem, itemId], (error, results, fields) => {
        if (error) {
...
router.delete('/:id', (req, res) => {
    ...
    db.query('DELETE FROM states WHERE id = ?', [id], (error, results, fields) => {
        if (error) {
