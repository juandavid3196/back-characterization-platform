...
router.get('/', (req, res) => {
    db.query('SELECT * FROM sub_eventos', (error, results, fields) => {
        if (error) {
...
router.get('/:id', (req, res) => {
    ...
    db.query('SELECT * FROM sub_eventos WHERE id = ?', [itemId], (error, results, fields) => {
        if (error) {
            console.error('Error al ejecutar la consulta:', error);
...
router.post('/', (req, res) => {
    ...
    db.query('INSERT INTO sub_eventos SET ?', newItem, (error, results, fields) => {
        if (error) {
...
router.put('/:id', (req, res) => {
    ...
    db.query('UPDATE sub_eventos SET ? WHERE id = ?', [updatedItem, itemId], (error, results, fields) => {
        if (error) {
...
router.delete('/:id', (req, res) => {
    ...
    db.query('DELETE FROM sub_eventos WHERE id = ?', [id], (error, results, fields) => {
        if (error) {
