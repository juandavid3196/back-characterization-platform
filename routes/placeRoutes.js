...
router.get('/', (req, res) => {
    db.query('SELECT * FROM places', (error, results, fields) => {
        if (error) {
...
router.get('/:id', (req, res) => {
    ...
    db.query('SELECT * FROM places WHERE id = ?', [itemId], (error, results, fields) => {
        if (error) {
            console.error('Error al ejecutar la consulta:', error);
...
router.post('/', (req, res) => {
    ...
    db.query('INSERT INTO places SET ?', newItem, (error, results, fields) => {
        if (error) {
...
router.put('/:id', (req, res) => {
    ...
    db.query('UPDATE places SET ? WHERE id = ?', [updatedItem, itemId], (error, results, fields) => {
        if (error) {
...
router.delete('/:id', (req, res) => {
    ...
    db.query('DELETE FROM places WHERE id = ?', [id], (error, results, fields) => {
        if (error) {
