...
router.get('/:id', (req, res) => {
    ...
    db.query('SELECT * FROM subeventstates WHERE id = ?', [itemId], (error, results, fields) => {
        if (error) {
            console.error('Error al ejecutar la consulta:', error);
...
router.put('/:id', (req, res) => {
    ...
    db.query('UPDATE subeventstates SET ? WHERE id = ?', [updatedItem, itemId], (error, results, fields) => {
        if (error) {
...
router.delete('/:id', (req, res) => {
    ...
    db.query('DELETE FROM subeventstates WHERE id = ?', [id], (error, results, fields) => {
        if (error) {
